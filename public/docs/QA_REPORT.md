...
- Новый прогон: `47/47` public QA, `18/18` admin QA, `13/13` тестов закладок и копирования названий; статическая сборка и проверка синтаксиса `public/app.js` успешны.
