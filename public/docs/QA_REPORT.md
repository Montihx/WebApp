...
Дата последней сверки документа с `qa-results.json`: 2 сентября 2026 года.
...
- hero: пять слайдов, автопереключение через 7 секунд, стрелки на всех ширинах, keyboard, swipe и исключение скрытых ссылок из tab-порядка; после ручного взаимодействия автопереключение не возобновляется. Плашка индикаторов, счётчик, пауза, нижний progress и «О тайтле» удалены из runtime;
