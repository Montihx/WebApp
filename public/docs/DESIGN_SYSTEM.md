...
- На `≤720 px` общий header заменяется контекстным toolbar: back слева, уведомления справа. Постер становится полноширинным визуальным якорем с production-пропорцией `3:4`, а название и действия накладываются на его нижнюю границу через спокойную маску.
...
- Уведомления открывают единый адаптивный dialog: обычное окно на desktop и bottom sheet на mobile. Отдельное share-действие и повторная секция подробностей не показываются.
