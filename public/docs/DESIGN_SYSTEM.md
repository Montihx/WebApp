...
- На desktop постер, просмотр и список образуют левую колонку; под ними в одной компактной строке находятся `favorites_count`, `comments_count` и уведомления. Справа остаются название, естественные metadata-строки, жанры и описание — без отдельной статистической таблицы.
- На `≤720 px` общий header заменяется контекстным toolbar: back слева, уведомления справа. Постер становится полноширинным визуальным якорем, а название и действия накладываются на его нижнюю границу через спокойную маску.
